...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\adosh\\Desktop\\Lab_Psychology\\Class 9\\Intentional Binding Task_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('binding task excel.xlsx'),
